...
$razorpay_id='onlineshoes@gmail.com'; // Business email ID
?>
<?php
...
<div id="container">
	...
	<legend></legend>
	<h4>TOTAL: MRP:₹ <?php echo $amnt; ?></h4>
	</form>
	<div class='pull-right'>
<div class="">
    <form action="<?php echo $paypal_url ?>" method="post" >
    <input type="hidden" name="business" value="<?php echo $razorpay_id; ?>">
    ...
    <input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif"  name="submit" alt="RazorPay - The safer, easier way to pay online!">
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Online Shoes Store 2024</p>
		</div>
